...
class Exercitiu {
    ...
    public:
        ...
        Exercitiu(const std::string& nume,const std::string& categorie, double calorii_arse_pe_min, int durata,const std::string& dificultate) {
            this->nume = nume;
        ...
        double get_calorii_arse_pe_min() const{
            return this->calorii_arse_pe_min;
        }
